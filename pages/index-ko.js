...
export default function KoreanHome() {
  ...
  <a href="/contact" className="hover:underline">Contact</a>
</nav><div className="mt-2 md:mt-0"><a href="/" className="bg-white text-blue-900 px-3 py-1 rounded text-sm hover:bg-blue-100 transition">English</a></div>
      </header>
      ...
      <main className="px-4 md:px-12 py-10 space-y-16">
        ...
        <section>
          <h2 className="text-2xl md:text-3xl font-semibold text-blue-400 mb-6">추천 부동산</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-800 rounded-xl p-4 shadow hover:shadow-xl transition transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold">베벌리 힐즈 빌라</h3>
              <p>$4.2M · 5 침실 · 6 욕실</p>
            </div>
            <div className="bg-gray-800 rounded-xl p-4 shadow hover:shadow-xl transition transform hover:-translate-y-1">
              <img src="/property2.jpg" alt="Property 2" className="rounded-md mb-4 w-full"/>
              <h3 className="text-xl font-bold">뉴욕 펜트하우스</h3>
              <p>$7.5M · 4 침실 · 4.5 욕실</p>
            </div>
            <div className="bg-gray-800 rounded-xl p-4 shadow hover:shadow-xl transition transform hover:-translate-y-1">
              <img src="/property3.jpg" alt="Property 3" className="rounded-md mb-4 w-full"/>
              <h3 className="text-xl font-bold">마이애미 워터프론트</h3>
              <p>$6.9M · 6 침실 · 7 욕실</p>
            </div>
          </div>
        </section>
