  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn about Axion Capitals' mission and values." />
      </Head>
      ...
      <main className="pt-28 bg-gradient-to-b from-white via-gray-50 to-blue-100 min-h-screen">
        <section className="max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            Axion Capitals is a forward-looking global venture focused on bridging international trade and investment
            through smart, secure, and confidential strategies.
          </p>
          <p className="text-gray-700 max-w-3xl mx-auto">
            Our mission is to empower meaningful global commerce by connecting clients with verified suppliers,
            secure logistics networks, and strategic cross-border investment channels. We are proud to maintain
            discretion and integrity at every step, providing high-value partnerships across continents.
          </p>
        </section>
      </main>
