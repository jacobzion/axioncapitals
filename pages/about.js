...
export default function About() {
  ...
  return (
    <>
      <Head>
        <title>About | Axion Capitals</title>
        <meta name="description" content="Learn more about Axion Capitals – your trusted global trading partner." />
      </Head>
      ...
      <main className="pt-28 bg-black min-h-screen text-white">
        <section className="max-w-4xl mx-auto px-6 py-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-blue-400 mb-6">About Axion Capitals</h1>
          <p className="text-lg text-gray-300 mb-6">
            Axion Capitals is a strategic trade bridge connecting trusted suppliers and buyers across continents.
          </p>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Founded on the principles of confidentiality, integrity, and speed, our mission is to streamline international trade with advanced technologies and trusted partnerships. We work with high-demand commodities and specialized market insights across East Asia, South America, and Europe.
          </p>
        </section>
      </main>
